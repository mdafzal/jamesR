...
<head>
	...
	wp_enqueue_script('cycle', get_stylesheet_directory_uri() . '/js/jquery.cycle.all.min.js', 'jquery', false);
	wp_enqueue_script('cookie', get_stylesheet_directory_uri() . '/js/jquery.cookie.js', 'jquery', false);
	wp_enqueue_script('timeago', get_stylesheet_directory_uri() . '/js/script.js', 'jquery', false); ?>
	...
	<?php 
		$technews_theme_settings = get_option('supreme_theme_settings');
		if ( isset($technews_theme_settings['customcss']) && $technews_theme_settings['customcss']==1 ) { ?>
...
<div class="top_header_part">
	<div class="top_header_wrap">
		...
		<?php if (function_exists('dynamic_sidebar')){ dynamic_sidebar('primary_menu_widget_area'); }?>
	</div>
</div>
...
<div class="header-wrap clearfix">
	...
	<h1 id="site-title"> <a href="<?php echo home_url(); ?>/" title="<?php echo bloginfo( 'name' ); ?>" rel="Home"> <img class="logo" style="max-width: 100%; height: auto;" src="<?php echo hybrid_get_setting( 'supreme_logo_url' ); ?>" alt="<?php echo bloginfo( 'name' ); ?>" /> </a> </h1>
	<?php else : ?>
