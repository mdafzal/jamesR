	...
	<li id="comment-<?php comment_ID(); ?>" class="<?php hybrid_comment_class(); ?>">
		...
		<div class="comment-wrap">
			...
			<div class="comment-header">
				...
				<?php echo apply_atomic_shortcode( 'comment_meta', '<div class="comment-meta">[comment-author] <i class="fa fa-clock-o"></i>[comment-published] [comment-permalink before=" . "] [comment-edit-link before=" . "]</div>' ); ?>
			</div><!-- .comment-header -->
			...
			<?php echo apply_atomic_shortcode( 'comment_meta', '<div class="templatic_comment"><i class="fa fa-share"></i>[comment-reply-link]</div>' ); ?>
