...
?>
	...
	<?php elseif ( is_search() ) : ?>
		...
		<?php global $displaytype; ?>
			...
			<div class="loop-description">
				<p>
				<?php printf( __( 'You are browsing the search results for "%s"', 'supreme' ), esc_attr( get_search_query() ) ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_date() ) : ?>
		...
		<div class="loop-meta">
			<h1 class="loop-title"><?php _e( 'Archives by date', 'supreme' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'You are browsing the site archives by date.', 'supreme' ); ?>
				</p>
			</div><!-- .loop-description -->
	...
	<?php elseif ( is_archive() ) : ?>
		...
		<div class="loop-meta">
			...
			<h1 class="loop-title"><?php _e( 'Archives', 'supreme' ); ?></h1>

			<div class="loop-description">
				<p>
				<?php _e( 'You are browsing the site archives.', 'supreme' ); ?>
				</p>
			</div><!-- .loop-description -->
